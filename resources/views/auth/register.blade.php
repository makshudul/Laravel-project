                                    ...
                                    <form action="{{url('/customer/login')}}" method="POST">
                                        ...
                                        <div class="form_item_wrap">
                                            ...
                                            <div class="form_item">
                                                ...
                                                <input id="username_input" type="text" name="email" placeholder="Enter Email">
                                            </div>
                                        </div>
                                    ...
                                    <form action="{{url('/customer/register')}}" method="POST">
                                        ...
                                        <div class="form_item_wrap">
                                            ...
                                            <div class="form_item">
                                                ...
                                                <input id="username_input2" type="text" name="name" placeholder="Enter Name">
                                            </div>
                                        </div>
                                        <div class="form_item_wrap">
                                            <h3 class="input_title">Email*</h3>
                                        ...
                                        <div class="form_item_wrap">
                                            ...
                                            <div class="form_item">
                                                ...
                                                <input id="password_input2" type="password" name="password" placeholder=" Enter Password">
                                            </div>
                                        </div>
