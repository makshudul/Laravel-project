                  ...
                  <div class="row">
                     <div class="col col-xs-12">
                        <div class="woocommerce bg-light p-3">
                           <form name="checkout" method="post" class="checkout woocommerce-checkout" action="{{route('order')}}">
                             @csrf
                                 ...
                                 <table class="shop_table woocommerce-checkout-review-order-table">
                                       ...
                                       <tr class="shipping">
                                         <td>
                                            ...
                                            <input id="in" type="radio" class="input-radio location" name="delivery_charge" value="60"/>
                                            <label for="in">Insite City ( 60 tk) </label>
                                              <br>
                                            <input id="out" type="radio" class="input-radio location" name="delivery_charge" value="100"/>
                                            <label for="out">Outsite City ( 100 tk)</label>
                                         </td>
                                       </tr>
                                       <tr class="order-total">
                                          ...
                                          @endphp
                                          <td><strong><span class="woocommerce-Price-amount grand_total">{{ intval($sub_total - ($sub_total*$discount)/100)}}</span></strong> </td>
                                       </tr>
                                 </table>
...
$('.location').click(function(){
    ...
    var grand_total=total+parseInt(charge);
    $('.grand_total').html(Math.ceil(grand_total));
})
...
@if (session('Order_insert'))
<script>
    Swal.fire({
  position: 'center',
  icon: 'success',
  title: '{{session('Order_insert')}}',
