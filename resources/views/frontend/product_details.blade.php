            ...
            <section class="product_details section_space pb-0">
                <div class="container">
                    <div class="row">
                        <div class="col col-lg-6">
                            <div class="product_details_image">
                                <div class="details_image_carousel">
                                    @foreach ($product_info->rel_to_product_thumbnail as $show_thumbnails_image )
                                    <div class="slider_item">
                                        <img src="{{asset('uploads/products/thumbnails')}}/{{$show_thumbnails_image->thumbnails}}" alt="image_not_found">
                                    </div>
                                    @endforeach
                                </div>
                        ...
                        <div class="col-lg-6">
                            <form action="{{route('frontend.cart_insert')}}" method="POST">
                                @csrf
                            ...
                            <div class="product_details_content">
                                ...
                                <div class="item_price">
                                    <span>Tk <span id="total"> {{$product_info->after_discount}}</span></span>
                                ...
                                <hr>
                                    <div class="quantity_wrap">
                                        <div class="quantity_input">
                                            ...
                                            <input class="input_number" type="text" value="1" name="quanity">
                                            <button type="button" class="input_number_increment">
                                                <i class="fal fa-plus"></i>
                                            </button>
                                        </div>
                                        <div class="total_price">Total : <span id="grand_total">{{$product_info->after_discount}}</span> </div>
                                    </div>
                                ...
                                <div class="product-area clearfix">
                                    ...
                                    <div class="grid">
                                        <div class="product-pic">
                                            <img src="{{asset('uploads/products/preview')}}/{{$related_products->preview}}" alt>
                                            <div class="actions">
                                                <ul>
                                                    <li>
                                        ...
                                        <div class="details">
                                            <h4><a href="#">{{$related_products->product_name}}</a></h4>
                                            <p><a href="#">{{$related_products->short_desp}}</a></p>
                                            <div class="rating">
                                            ...
                                            <span class="price">
                                                <ins>
                                                    <span class="woocommerce-Price-amount amount">
                                                        <bdi>
                                                            <span class="woocommerce-Price-currencySymbol">Tk</span>{{$related_products->after_discount}}
                                                        </bdi>
                                                    </span>
                                                </ins>
                                            </span>
