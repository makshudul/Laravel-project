...
<body>
    ...
    <div class="body_wrap">
        ...
        ================================================== -->
        <header class="header_section {{(Route::currentRouteName()=='homepage'?'header-style-no-collage':'header-style-3')}}">
            <div class="header_top">
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-md-6">
                            <p class="header_hotline">Call us toll free: <strong>+88 015711-64542</strong></p>
                        </div>
                    </div>
                </div>
            </div>
                               ...
                               <ul class="header_icons_group ul_li_right">
                                    <li>
                                        <a href="">
                                            ...
                                            <span class="wishlist_counter">{{App\Models\wishlist::where('user_id',Auth::guard('customerlogin')->id())->count()}}</span>
                                        </a>
                                    </li>
                                    <li>
                                ...
                                <div class="allcategories_collapse {{(Route::currentRouteName()=='homepage'?'':'collapse')}}" id="allcategories_collapse">
                                    <div class="card card-body">
                                        <ul class="allcategories_list ul_li_block">
                                            @foreach (App\Models\Category::all() as $category )
                                            <li><a href="{{route('fontend.category_Product_details',$category->id)}}"><i class="fas fa-chevron-right"></i> {{$category->category_name}}</a></li>
                                            @endforeach
                                ...
                                <li>
                                     ...
                                     <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                          ...
                                          <li><a class="dropdown-item" href="{{route('account_logout')}}">Logout</a></li>
                                        </ul>
                                      </div>
                                     @else
                                     <a href="{{route('coustomer_register')}}">Login</a>
        ...
        ================================================== -->
                ...
                <div class="cart_sidebar">
                    ...
                    <ul class="cart_items_list ul_li_block mb_30 clearfix">
                        ...
                        <li>
                            ...
                            <a href="{{route('frontend.cart_delete',$cart->id)}}" class="remove_btn"><i class="fal fa-trash-alt"></i></a>
                        </li>
                        @php
                    ...
                    <ul class="btns_group ul_li_block clearfix">
                        <li><a class="btn btn_primary" href="{{route('frontend.cart')}}">View Cart</a></li>
                    </ul>
                </div>
          ...
          <!-- content_space_section - start
        ================================================== -->
        @yield('content')

        <!-- contentspace_section - end
        ================================================== -->
