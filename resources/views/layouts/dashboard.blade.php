        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{route('home')}}" class="brand-logo">
                <img  class="logo-title" src="{{asset('/dashboard_asset/images/logo.png')}}" alt="">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img style="border-radius: 50%" src="{{asset('uploads/users')}}/{{Auth::user()->image}}" width="20" alt=""/>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{route('profile_index')}}" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a  href="{{route('home')}}" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a href="{{route('add_users')}}">Add User</a></li>
                                <li><a href="{{route('users')}}">View User</a></li>
                            </ul>
                        </li>
                            @endif
                                      {{-- end uses menu --}}
                    ...
                    <li><a  href="{{route('category')}}" aria-expanded="false">
                        ...
                        <span class="nav-text">Category</span>
                          ...
                          {{-- // this is sub category menu  --}}
                    <li><a href="{{route('Subcategory')}}" aria-expanded="false">
                ...
                <ul aria-expanded="false">
                    ...
                    <li><a href="{{route('backend.showProducts')}}">View Product</a></li>
                </ul>
                </li>
                                  {{-- end product menu --}}
                 {{-- // this is coupon menu  --}}
                ...
                <ul aria-expanded="false">
                    <li><a href="{{route('backend.coupon_index')}}">Add Coupon</a></li>
                </ul>
                </li>
                                  {{-- end coupon  menu --}}

                 {{-- // this is Order menu  --}}
                   <li><a  href="{{route('backend.order')}}" aria-expanded="false">
                    ...
                    <span class="nav-text">Order</span>
                                  ...
                                  {{-- end coupon  menu --}}
                                 {{-- // this is Order menu  --}}
                   <li><a href="{{route('backend.need_product')}}" aria-expanded="false">
                    <i class="fa fa-shopping-cart"></i>
                    <span class="nav-text">Need buy Product</span>
                </a>
                </li>
                                  {{-- end coupon  menu --}}
                </ul>
